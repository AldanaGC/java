...
public class homeBanking{
    public static void main(String[] args) {
        ...
        int saldo = 50000;
        int monto, totalPagos;
        monto = 0;
        opcion = "";
        sesion = "";
        usuarioGuardado = "java";
        claveGuardada = "CAC2022";
        sesionContinuar = "S";
       ...
       switch (opcion) {
        ...
        case "B":
            ...
            System.out.println("¿Desea proceder al pago de lo mismos? Ingrese S para continuar al pago, N para terminar");
            opcion = miTeclado.nextLine();
